...
const TRADUCOES = {
  'pt-BR': {
    ...
    /* ── Fala — modo acessível ── */
    fala_bemvindo:    'Bem-vindo ao modo acessível. Você está no Menu Principal. Primeira opção: Ver Cardápio. Utilize clique curto para avançar. Clique longo para selecionar. Duplo clique para voltar.',
    fala_menu_cardapio:  'Opção: Ver Cardápio. Clique longo para abrir as categorias.',
    fala_menu_carrinho:  'Opção: Ver Carrinho e Finalizar. Você tem {qtd} itens. Total: {total}.',
    fala_cat:            'Categoria: {nome}. {qtd} itens.',
    fala_prod:           '{nome}. {desc}. Valor {preco}. Clique longo para ver opções.',
    fala_op_adicionar:   'Adicionar uma unidade.',
    fala_op_remover:     'Remover uma unidade.',
    fala_op_concluir:    'Concluir e fechar.',
    fala_opcao:          'Opção: {op} Clique longo para confirmar.',
    ...
    fala_cardapio_aberto:'Cardápio aberto. Primeira categoria: {nome}. {qtd} itens.',
    ...
    fala_cat_selecionada:'Categoria {nome} selecionada. Primeiro item: {prod}. {preco}.',
    fala_prod_selecionado:'Produto {nome} selecionado. Valor {preco}. Você tem {qtd} selecionado para adicionar. Opção atual: Adicionar uma unidade. Clique curto para ver mais opções. Clique longo para selecionar. Duplo clique para cancelar.',
  ...
  'en-US': {
    ...
    /* ── Fala — modo acessível ── */
    fala_bemvindo:    'Welcome to accessible mode. You are in the Main Menu. First option: View Menu. Use a short press to advance. Long press to select. Double press to go back.',
    fala_menu_cardapio:  'Option: View Menu. Long press to open categories.',
    fala_menu_carrinho:  'Option: View Cart and Checkout. You have {qtd} items. Total: {total}.',
    fala_cat:            'Category: {nome}. {qtd} items.',
    fala_prod:           '{nome}. {desc}. Price {preco}. Long press for options.',
    fala_op_adicionar:   'Add one unit.',
    fala_op_remover:     'Remove one unit.',
    fala_op_concluir:    'Done and close.',
    fala_opcao:          'Option: {op} Long press to confirm.',
    ...
    fala_cardapio_aberto:'Menu opened. First category: {nome}. {qtd} items.',
    ...
    fala_cat_selecionada:'Category {nome} selected. First item: {prod}. {preco}.',
    fala_prod_selecionado:'Product {nome} selected. Price {preco}. You have {qtd} selected to add. Current option: Add one unit. Short press for more options. Long press to select. Double press to cancel.',
